...
public class AppBarLayoutBehaviorFix2 extends AppBarLayout.Behavior {
    ...
    public AppBarLayoutBehaviorFix2(int nestedScrollViewId) {
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout abl, View target, int type) {
        if (request) {
            NestedScrollView nestedScrollView = coordinatorLayout.findViewById(nestedScrollViewId);
            if (expand) {
                ...
                if (nestedScrollView.getScrollY() > 0) {
                    ...
                    if (finalY <= 0) {
                        ...
                        expandAppBarLayoutWithVelocity(coordinatorLayout, abl, velocity);
                    }
                }
            } else {
                //onNestedFling will collapse the AppBarLayout with an animation time relative to the velocity
                onNestedFling(coordinatorLayout, abl, target, 0, velocity, true);
